                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-6 col-lg-5">
                        ...
                        <p class="text-muted mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                      ...
                      <div class="row">
                        ...
                        <div class="col d-flex align-items-center">
                          <div class="image-grouped ml-auto">
                            <img src="@/assets/images/faces/face20.jpg" data-toggle="tooltip" data-placement="top"
                              title="" alt="profile image" data-original-title="Mary Sharp">
                            <img src="@/assets/images/faces/face17.jpg" data-toggle="tooltip" data-placement="top"
                              title="" alt="profile image" data-original-title="Cory Medina">
                            <img src="@/assets/images/faces/face14.jpg" data-toggle="tooltip" data-placement="top"
                              title="" alt="profile image" data-original-title="Clyde Hammond">
                  ...
                  <div class="wrapper border-top">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col d-flex align-items-center">
                          <div class="image-grouped ml-auto">
                            <img src="@/assets/images/faces/face11.jpg" data-toggle="tooltip" data-placement="top"
                              title="" alt="profile image" data-original-title="Mary Sharp">
                            <img src="@/assets/images/faces/face12.jpg" data-toggle="tooltip" data-placement="top"
                              title="" alt="profile image" data-original-title="Cory Medina">
                            <img src="@/assets/images/faces/face23.jpg" data-toggle="tooltip" data-placement="top"
                              title="" alt="profile image" data-original-title="Clyde Hammond">
                            <div class="text-avatar" data-toggle="tooltip" data-placement="top" title=""
                              data-original-title="4 More Peoples"><span class="d-block pt-2">+4</span></div>
                          </div>
                ...
                <div class="card rounded shadow-none">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6 col-lg-5 d-lg-flex">
                        <div class="user-avatar mb-auto">
                          <img src="@/assets/images/faces/face3.jpg" alt="profile image"
                            class="profile-img img-lg rounded-circle">
                          <span class="edit-avatar-icon"><i class="mdi mdi-camera"></i></span>
                        </div>
                        <div class="wrapper pl-lg-4">
                      ...
                      <div class="col-sm-6 col-lg-5">
                        <div class="d-flex align-items-center w-100">
                          <p class="mb-0 mr-3 font-weight-semibold">Progress</p>
                          <div class="progress progress-md w-100">
                            <div class="progress-bar bg-success" role="progressbar" style="width: 77%" aria-valuenow="77"
                              aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                  ...
                  <div class="wrapper border-top">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col d-flex align-items-center">
                          <div class="image-grouped ml-auto">
                            <img src="@/assets/images/faces/face8.jpg" data-toggle="tooltip" data-placement="top" title=""
                              alt="profile image" data-original-title="Mary Sharp">
                            <img src="@/assets/images/faces/face7.jpg" data-toggle="tooltip" data-placement="top" title=""
                              alt="profile image" data-original-title="Cory Medina">
                            <img src="@/assets/images/faces/face9.jpg" data-toggle="tooltip" data-placement="top" title=""
                ...
                <div class="card rounded shadow-none">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6 col-lg-5 d-lg-flex">
                        <div class="user-avatar mb-auto">
                          <img src="@/assets/images/faces/face6.jpg" alt="profile image"
                            class="profile-img img-lg rounded-circle">
                          <span class="edit-avatar-icon"><i class="mdi mdi-camera"></i></span>
                        </div>
                        <div class="wrapper pl-lg-4">
                  ...
                  <div class="wrapper border-top">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col d-flex align-items-center">
                          <div class="image-grouped ml-auto">
                            <img src="@/assets/images/faces/face13.jpg" data-toggle="tooltip" data-placement="top"
                              title="" alt="profile image" data-original-title="Mary Sharp">
                            <img src="@/assets/images/faces/face14.jpg" data-toggle="tooltip" data-placement="top"
                              title="" alt="profile image" data-original-title="Cory Medina">
                            <img src="@/assets/images/faces/face4.jpg" data-toggle="tooltip" data-placement="top" title=""
                              alt="profile image" data-original-title="Clyde Hammond">
                            <div class="text-avatar" data-toggle="tooltip" data-placement="top" title=""
                              data-original-title="4 More Peoples"><span class="d-block pt-2">+2</span></div>
                          </div>
                        </div>
                      </div>
                    </div>
